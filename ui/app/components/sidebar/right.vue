...
<template>
    <div
        class="absolute top-4 right-4 h-[calc(100vh-2rem)] w-96 rounded-lg border-4 border-amber-800
            bg-amber-900 p-1 shadow-2xl shadow-black"
    >
        <!-- Inner Frame -->
        <div class="flex h-full flex-col rounded border-2 border-amber-700/50 bg-amber-900 p-4">
            ...
            <div class="text-center font-serif text-amber-300/40 italic">Empty</div>
        </div>
    </div>
</template>
